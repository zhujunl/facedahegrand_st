    ...
    public void checkConfig() {
        ...
        if (config == null) {
            config = new Config.Builder()
                    ...
                    .uploadRecordUrl1(Constants.DEFAULT_UPLOAD_URL_1)
                    .uploadRecordUrl2(Constants.DEFAULT_UPLOAD_URL_2)
